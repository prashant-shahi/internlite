	...
	<div class="collapse navbar-collapse" id="collapsibleNavbar">
		<ul class="navbar-nav mr-auto">
			...
			if(!isset($_SESSION['success']) || empty($_SESSION['success']))
			{
				?>
				<li class="nav-item">
					<a class="active nav-link" href="#"><i class="far fa-building fa-lg"></i> Employer Portal</a>
				</li>
				<li class="nav-item">
...
<div class="row justify-content-md-center pt-2">
	<div class="col-sm-8">
		<div>
			<h2 class="text-white bg-info text-center">Employer Login</h2>
		</div>
		<form action="" method="POST">
			...
			<input type="submit" name="employer-login" value="LOGIN" class="btn btn-info" />
			<a class="pl-3" href="employer-register.php">New to platform? Register!</a>
		</form>
	</div>
</div>
